REM This script is /u01/app/oracle/product/11.2.0/dbhome_1/rdbms/admin/catbundle_PSU_PREPAID_ROLLBACK.sql
REM It was generated by catbundle.sql on 2016Jul22_16_21_07
SET echo on
COLUMN spool_file NEW_VALUE spool_file NOPRINT
SELECT '/u01/app/oracle/cfgtoollogs/catbundle/' || 'catbundle_PSU_' || name || '_ROLLBACK_' || TO_CHAR(SYSDATE, 'YYYYMonDD_hh24_mi_ss', 'NLS_DATE_LANGUAGE=''AMERICAN''') || '.log' AS spool_file FROM v$database;
SPOOL &spool_file

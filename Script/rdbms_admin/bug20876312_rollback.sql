Rem
Rem $Header: rdbms/admin/bug20876312_rollback.sql /st_rdbms_11.2.0.4.0dbpsu/2 2015/05/12 23:28:52 ratakuma Exp $
Rem
Rem bug20876312_rollback.sql
Rem
Rem Copyright (c) 2015, Oracle and/or its affiliates. All rights reserved.
Rem
Rem    NAME
Rem      bug20876312_rollback.sql - <one-line expansion of the name>
Rem
Rem    DESCRIPTION
...
Rem    SQL_SOURCE_FILE: rdbms/admin/bug20876312_rollback.sql

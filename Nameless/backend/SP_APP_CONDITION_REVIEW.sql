CREATE OR REPLACE PROCEDURE BACKEND_DEV.SP_APP_CONDITION_REVIEW 
(
...
BEGIN
   DECLARE
      APP_CONDITION_REVIEW_ID   NUMBER := 12;
   ...
   BEGIN
      SELECT EVENT_CODE, EVENT_DESC, EVENT_OBJECT
        ...
        FROM EVENT_DEF
       WHERE ID = APP_CONDITION_REVIEW_ID;
      /* CAR APP CONDITION */
      ...
      LOOP
        ...
        /* RUN ACTION
           SP_RUN_ACTION_EVENT_APP_CONS (APP_CONDITION_REVIEW_ID,
                                vEVENT_EXECUTION_ID,
                                car.ID,
                                vEVENT_OBJECT,
                                p_SYSTRAN_ID,
           ...
           DBMS_OUTPUT.PUT_LINE('START ACTION');
            SP_RUN_ACTION_EVENT ( APP_CONDITION_REVIEW_ID,
                                vEVENT_EXECUTION_ID,
                                car.ID,
                                vEVENT_OBJECT,
                                p_SYSTRAN_ID,
...
EXCEPTION
   ...
   THEN
      ...
      DBMS_OUTPUT.PUT_LINE (
            'SP_APP_CONDITION_REVIEW: Exception when executing');
      RAISE;
END SP_APP_CONDITION_REVIEW;
/
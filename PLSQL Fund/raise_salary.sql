...
/*
Program-defined exceptions are declared here and are used to identify exception events which will interrupt main program execution.
*/
...
/*
If the existing salary is unknown or NULL, or if it is 0, then no raise is possible. Otherwise, compute the raise amount and issue an update to the database.
*/
	IF old_salary IS NOT NULL
	AND old_salary > 0 THEN

/*
Convert the employee_pct parameter value to a numeric percentage and update the appropriate database column.
*/
...
EXCEPTION
/*
Set the output parameter value here as well based upon program-defined and system-defined exceptions which might occur.
*/
